...
namespace AssistenciaTech.Application.Tests
{
    public class AdminControllerTests
    {
        ...
        public async Task Index_WhenDashboardServiceThrowsException_ReturnsViewWithEmptyListAndErrorViewBag()
        {
            ...
            var controller = new AdminController(context, mockEstoqueService.Object, mockEnv.Object, mockPdfService.Object, mockDashboardService.Object, mockEquipamentoBackupService.Object, mockLogger.Object, new MemoryCache(new MemoryCacheOptions()));
