    ...
    public class PdfGeneratorService : IPdfGeneratorService
    {
        ...
        private void ComposeReciboContent(IContainer container, Faturamento faturamento, OrdemServico os, Cliente cliente)
        {
            container.PaddingVertical(1, Unit.Centimetre).Column(column =>
            {
                ...
                ComposeReciboTextoBlock(column, faturamento, os, cliente);
                ComposeReciboValoresTable(column, faturamento, os);
                ComposeReciboAssinaturaBlock(column);
            });
        }

        private void ComposeReciboTextoBlock(ColumnDescriptor column, Faturamento faturamento, OrdemServico os, Cliente cliente)
        {
        ...
        private void ComposeReciboValoresTable(ColumnDescriptor column, Faturamento faturamento, OrdemServico os)
        {
            column.Item().Table(table =>
            {
                table.ColumnsDefinition(columns =>
        ...
        private void ComposeReciboAssinaturaBlock(ColumnDescriptor column)
        {
